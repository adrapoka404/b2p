        ...
        <div class=" text-center text-blue-300 font-semibold text-xl my-16" id="enqueinvierte">
            ...
            <div class=" max-w-screen-xl mx-auto">
                ...
                <div class="grid grid-cols-2 grid-rows-2">
                    <div class="w-full">
                        <div class="my-10 w-11/12 h-96 bg-contain bg-no-repeat mx-auto">
                            <div class="w-96 h-96 bg-gray">
                                <video   autoplay loop muted src="{{asset("img/register/animation_register.mp4")}}">
                                    <source src="{{asset("img/register/animation_register.mp4")}}" type="video/mp4">
                    ...
                    <div class="w-full">
                        <div class="my-10  w-11/12 h-96 bg-contain bg-no-repeat mx-auto">
                            <div class="w-96 h-96 bg-gray">
                                <video   autoplay loop muted src="{{asset("img/elige/animation_elige.mp4")}}">
                                    <source src="{{asset("img/elige/animation_elige.mp4")}}" type="video/mp4">
                                  Your browser does not support the video tag.
                              </video>
                            </div>
                        </div>
                    ...
                    <div class="w-full">
                        <div class="my-10  w-11/12  h-96 bg-contain bg-no-repeat mx-auto">
                            <div class="w-96 h-96 bg-gray">
                                <video   autoplay loop muted src="{{asset("img/invierte/animation_invierte.mp4")}}">
                                    <source src="{{asset("img/invierte/animation_invierte.mp4")}}" type="video/mp4">
                                  Your browser does not support the video tag.
                              </video>
                            </div>
                        </div>
                    ...
                    <div class="w-full mt-10">
                        <div class="my-14  w-11/12 h-96 bg-contain bg-no-repeat mx-auto">
                            <div class="w-96 h-96 bg-gray">
                                <video   autoplay loop muted src="{{asset("img/gana/animation_gana.mp4")}}">
                                    <source src="{{asset("img/gana/animation_gana.mp4")}}" type="video/mp4">
                                  Your browser does not support the video tag.
                              </video>
                            </div>
                        </div>
