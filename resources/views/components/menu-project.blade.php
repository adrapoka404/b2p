<div class="w-1/8 fixed">
    <div class="@if ($menu == 'testprojects.create') bg-proyecto-on @else bg-proyecto-off @endif bg-cover w-20 h-20 -m-10 text-center items-start text-xs pt-5 text-white cursor-pointer"></div>
