<nav x-data="{ open: false }" class="bg-white top-0 left-0 right-0 shadow-md shadow-gray">
                        ...
                        <x-jet-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <!-- Catalogos del sudo -->
                                    @can('projects.index')
                                        <x-jet-dropdown-link href="{{ route('projects.index') }}">
                                            {{ __('Proyectos') }}
                                        </x-jet-dropdown-link>
                                    @endcan
                        ...
                        <x-jet-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <!-- Catalogos del sudo -->
                                    @can('incomes.index')
                                        <x-jet-dropdown-link href="{{ route('incomes.index') }}">
                                            {{ __('Ingresos') }}
                                        </x-jet-dropdown-link>
                                    @endcan
                                    @can('economicactivities.index')
                                        <x-jet-dropdown-link href="{{ route('economicactivities.index') }}">
                                            {{ __('Actividades económicas') }}
                                        </x-jet-dropdown-link>
                                    @endcan
                                    @can('roles.index')
                                    ...
                                    <!-- Acciones del sudo -->
                                    @can('usersrole.index')
                                    <x-jet-dropdown-link href="{{ route('usersrole.index') }}">
                                        {{ __('Asignación de Roles') }}
                                    </x-jet-dropdown-link>
                                    @endcan
                                    @can('rolespermission.index')
                                    <x-jet-dropdown-link href="{{ route('rolespermission.index') }}">
