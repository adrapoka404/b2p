...
class SteepFiveController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('projects.steepfive', compact('projecttypes', 'generes', 'nationalities', 'economicactivities', 'incomes', 'influences', 'docs'));
    }
