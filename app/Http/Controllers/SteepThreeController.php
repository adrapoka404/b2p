...
class SteepThreeController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('projects.steepthree', compact('projecttypes', 'generes', 'nationalities', 'economicactivities', 'incomes', 'influences', 'docs', 'companies', 'years'));
    }
    ...
    public function store(Request $request)
    {
        ...
        echo "redirect steep four";
        return redirect()->route('steepfour.create');
    }
