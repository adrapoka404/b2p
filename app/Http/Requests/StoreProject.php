...
class StoreProject extends FormRequest
{
    ...
    {
        return [
            'project.name'                          => 'required|max:10',
            'project.project_type_id'               => 'required|numeric',
            'project.description'                   => 'required|min:200|max:600',
            'project.options.txt1'                  => 'required|max:250',
            'project.options.value1'                => 'required|max:250',
            'project.options.txt2'                  => 'required|max:250',
            'project.options.value2'                => 'required|max:250',
            'project.options.txt3'                  => 'required|max:250',
            'project.options.value3'                => 'required|max:250',
            ...
            'project.goal'                          => 'required|numeric',
            'project.goal_two'                      => 'required|numeric',
            'project.inputs.txt1'                   => 'required',
            'project.inputs.value1'                 => 'required|numeric',
            ...
            'project.origins.txt1'                  => 'required',
            'project.origins.value1'                => 'required|numeric',
            ...
            'project.request_max'                   => 'required|numeric',
            'project.request_min'                   => 'required:numeric',
            'project.debt'                          => 'nullable',
            'project.debs.txt1'                     => 'required_if:project.debt,on',
            'project.debs.value1'                   => 'required_if:project.debt,on', 
            ...
            'project.estimated_term'                => 'required|between:1,6',
            'project.estimated_ejecution'           => 'required|between:1,36',
            'project.min_investment'                => 'required|min:1000',
            ...
            'project.porcents.anual_porcent'        => 'nullable|numeric',
            'project.otros.porcent'                 => 'nullable|numeric',
            'project.porcents.anual_porcent'        => 'nullable|numeric',
            'project.otros.porcent'                 => 'nullable|numeric',
            'project.porcents.anual_porcent'        => 'nullable|numeric',
            'project.porcents.anual'                => 'nullable|numeric',
            'project.porcents.semestral_porcent'    => 'nullable|numeric',
            'project.porcents.semestral'            => 'nullable|numeric',
            'project.porcents.trimestral_porcent'   => 'nullable|numeric',
            'project.porcents.trimestral'           => 'nullable|numeric',
            'project.porcents.bimestral_porcent'    => 'nullable|numeric',
    ...
    public function messages()
    {
        return [
            ...
            'project.description.required'                   => 'El campo de descripcion es obligatorio',
            ...
            'project.options.txt1.required'                  => 'El campo de opción 1 en las características es obligatorio',
            'project.options.txt1.max'                  => 'El campo de opción 1 en las características no debe contener mas de 250 caracteres',
            'project.options.value1.required'                => 'El campo de descripción 1 en las características es obligatorio',
            'project.options.value1.max'                => 'El campo de descripción 1 en las características no debe contener mas de 250 caracteres',
            'project.options.txt2.required'                  => 'El campo de opción 2 en las características es obligatorio',
            'project.options.txt2.max'                 => 'El campo de opción 2 en las características no debe contener mas de 250 caracteres',
            'project.options.value2.required'                => 'El campo de descripción 2 en las características es obligatorio',
            'project.options.value2.max'                 => 'El campo de descripción 2 en las características no debe contener mas de 250 caracteres',
            'project.options.txt3.required'                  => 'El campo de opción 3 en las características es obligatorio',
            'project.options.txt3.max'                  => 'El campo de opción 3 en las características no debe contener mas de 250 caracteres',
            'project.options.value3.required'                => 'El campo de descripción 3 en las características es obligatorio',
            ...
            'project.location.required'                      => 'El campo de ubicación física es obligatorio',
            'project.goal.required'                          => 'El campo costo total del proyecto es obligatorio',
            'project.goal.numeric'                          => 'El campo costo total del proyecto debe ser numerico',
            'project.goal_two.required'                      => 'El campo Monto de tu inversión es obligatorio',
            'project.goal_two.numeric'                      => 'El campo monto de tu inversion debe ser numerico',
            'project.inputs.txt1.required'                   => 'El campo opción 1 en la columna de aportación es obligatorio',
            'project.inputs.value1.required'                 => 'El campo monto 1 en la columna de monto es obligatorio',
            ...
            'project.origins.txt1.required'                => 'El campo opción 1 en la columna origen de inversión es obligatorio',
            'project.origins.txt1.numeric'                => 'El campo monto 1 en la columna origen de inversión debe ser numerico',
            'project.origins.value1.required'                => 'El campo monto 1 en la columna origen de inversión es obligatorio',
            ...
            'project.request_max.required'                  => 'El campo de Monto máximo de inversion es obligatorio',
            'project.request_min.required'                       => 'El campo de Monto mínimo de inversion es obligatorio y no debe ser menor al 20% del monto máximo',
